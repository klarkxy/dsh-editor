...
- 建立统一的异步活动反馈体系：共享反馈原语、异步工作流动画，覆盖编辑工具与独立插件的活动状态，并沉淀为《界面与设计系统》的活动反馈词汇。

### 前置规划

- 章节规划前置到正文之前，正文页不再出现规划入口；附 e2e 闸门覆盖，工作流设计与验收见 [作者优先工作流](docs/author-first-workflow.md)。
...
- 优化 dev 构建链接、清理一次性验证脚本、补齐插件与工作台 e2e 覆盖并录制产品演示。
