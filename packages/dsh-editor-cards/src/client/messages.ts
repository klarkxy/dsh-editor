...
export const zh = {
  ...
  'cards.sort': '排序',
  'cards.sortName': '按名称',
  'cards.sortModified': '按修改时间',
  'cards.sortRole': '按身份',
  'cards.sortCategory': '按分类',
  'cards.newPerson': '新建人物卡',
  'cards.newSetting': '新建世界书条目',
  'cards.role': '身份',
  'cards.category': '分类',
  'cards.tags': '标签',
  ...
  'command.cardsCharacterHint': 'Ctrl+Shift+C · 在文件树中展开人物卡',
  'command.cardsWorldbook': '世界书',
  'command.cardsWorldbookHint': 'Ctrl+Shift+W · 在文件树中展开世界书',
  'common.cancel': '取消',
  'common.close': '关闭',
  'common.create': '创建',
  'common.save': '保存',
...
export const en: Record<MessageKey, string> = {
  ...
  'cards.closePanel': 'Close cards panel',
  'cards.back': 'Back to list',
  'cards.retry': 'Retry',
  'cards.name': 'Name',
  ...
  'command.cardsCharacterHint': 'Ctrl+Shift+C · reveal Characters in the file tree',
  'command.cardsWorldbook': 'Worldbook',
  'command.cardsWorldbookHint': 'Ctrl+Shift+W · reveal Worldbook in the file tree',
