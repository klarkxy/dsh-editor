...
export const zh = {
  'common.emDash': '—',
  'overview.title': '文档概览',
  'overview.intro': '文档状态、字数分布与近一个月的写作曲线。',
  'overview.close': '关闭概览',
  'overview.loading': '正在读取文档概览…',
  'overview.retry': '重试',
  'overview.filter': '筛选文档',
  'overview.filterPlaceholder': '筛选标题或路径',
  'overview.noMatch': '没有符合筛选的文档。',
  'overview.loadError': '未能读取文档概览。',
  'overview.totals': '合计',
  'overview.chapterCount': '文档数',
  'overview.totalChars': '总字数',
  'overview.statusDist': '状态分布',
  'overview.truncated': '目录较大，概览已截断。',
  'overview.chapterList': '文档列表',
  'overview.chapter': '文档',
  'overview.noChapters': '还没有文档。',
  'overview.charDist': '字数分布',
  'overview.noChart': '没有可绘制的文档。',
  ...
  'command.overview': '文档概览',
  'command.overviewHint': 'Ctrl+Shift+O · 文档状态与写作曲线',
  'error.diskChanged': '磁盘上的文件已变化，请重新读取后再试。',
  'error.notFound': '未找到该文件。',
  'error.sessionMissing': '会话已失效，请重新打开目录。',
...
export const en: Record<MessageKey, string> = {
  ...
  'overview.intro': 'Document status, character distribution, and the last month of writing.',
  'overview.close': 'Close overview',
  'overview.loading': 'Loading document overview…',
  'overview.retry': 'Retry',
  'overview.filter': 'Filter documents',
  'overview.filterPlaceholder': 'Filter by title or path',
  'overview.noMatch': 'No documents match the filter.',
  'overview.loadError': 'Could not load the document overview.',
  'overview.totals': 'Totals',
  'overview.chapterCount': 'Documents',
  ...
  'overview.chapterList': 'Documents',
  'overview.chapter': 'Document',
  'overview.noChapters': 'No documents yet.',
  'overview.charDist': 'Character distribution',
  'overview.noChart': 'No documents to chart.',
  ...
  'command.overview': 'Document overview',
  'command.overviewHint': 'Ctrl+Shift+O · document status and writing curve',
  'error.diskChanged': 'The file on disk changed. Read it again, then retry.',
  'error.notFound': 'That file was not found.',
  'error.sessionMissing': 'The session is gone. Open the folder again.',
