...
export const zh = {
  ...
  'overview.retry': '重试',
  'overview.filter': '筛选章节',
  'overview.filterPlaceholder': '筛选标题或路径',
  'overview.noMatch': '没有符合筛选的章节。',
  'overview.loadError': '未能读取作品概览。',
  'overview.totals': '合计',
...
export const en: Record<MessageKey, string> = {
  ...
  'overview.filter': 'Filter chapters',
  'overview.filterPlaceholder': 'Filter by title or path',
  'overview.noMatch': 'No chapters match the filter.',
  'overview.loadError': 'Could not load the work overview.',
