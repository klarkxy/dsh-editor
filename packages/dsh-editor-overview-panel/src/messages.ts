...
export const zh = {
  ...
  'overview.chapterMeta': '{chars} 字 · {modified}',
  ...
  'command.overviewHint': 'Ctrl+Shift+O · 字数与写作曲线',
...
export const en: Record<MessageKey, string> = {
  ...
  'overview.intro': 'Character distribution and the last month of writing.',
  ...
  'overview.chapterMeta': '{chars} chars · {modified}',
  ...
  'command.overviewHint': 'Ctrl+Shift+O · word count and writing curve',
