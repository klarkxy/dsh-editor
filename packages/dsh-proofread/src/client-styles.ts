...
.dsh-proofread-panel-title { margin: 0; font-size: var(--text-base, 14px); font-weight: 600; }
...
.dsh-proofread-panel-close:hover { color: var(--fg, #141413); background: var(--surface-warm, #e8e6dc); }
...
.dsh-proofread-check:hover:not(:disabled) { background: var(--accent-active, #142a48); }
...
.dsh-proofread-hint { color: var(--meta, #6b6a64); font-size: var(--text-xs, 11px); margin-left: auto; }
.dsh-proofread-hint.dsh-proofread-is-over { color: var(--danger, #8a3a30); }
.dsh-proofread-status { color: var(--meta, #6b6a64); padding: var(--space-2, 8px) 0; }
.dsh-proofread-error { color: var(--danger, #8a3a30); padding: var(--space-2, 8px) 0; }
.dsh-proofread-stale {
...
.dsh-proofread-result { display: flex; flex-direction: column; gap: var(--space-2, 8px); }
.dsh-proofread-result-summary { color: var(--fg-2, #3d3d3a); font-weight: 600; }
.dsh-proofread-habits { display: flex; flex-wrap: wrap; gap: var(--space-1, 4px); }
.dsh-proofread-habit {
  color: var(--meta, #6b6a64);
...
.dsh-proofread-findings { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: var(--space-2, 8px); }
...
.dsh-proofread-finding-head { display: flex; align-items: baseline; gap: var(--space-2, 8px); }
.dsh-proofread-finding-kind { font-weight: 600; color: var(--fg-2, #3d3d3a); }
.dsh-proofread-finding-pos { color: var(--meta, #6b6a64); font-size: var(--text-xs, 11px); margin-left: auto; font-family: var(--font-mono, monospace); }
.dsh-proofread-severity { width: 8px; height: 8px; border-radius: 50%; flex: none; align-self: center; }
.dsh-proofread-severity-error { background: var(--danger, #8a3a30); }
.dsh-proofread-severity-warning { background: var(--accent, #1b365d); }
.dsh-proofread-severity-info { background: var(--ghost, #78756c); }
.dsh-proofread-finding-message { color: var(--fg, #141413); }
