...
describe('peer ranges against the pinned host', () => {
  it('accepts the current DSH/cordis majors and rejects the next major', () => {
    ...
    expect(peerAllows('>=0.1.7-alpha.1 <0.2.0', '0.1.7-rc.2')).toBe(true)
    expect(peerAllows('>=0.1.7-rc.3 <0.2.0', '0.1.7-rc.2')).toBe(false)
    expect(peerAllows('<0.2.0', '0.1.7-rc.2')).toBe(true)
    expect(peerAllows('<0.1.0', '0.1.7-rc.2')).toBe(false)
    expect(peerAllows('^0.1.5', '0.1.7-rc.2')).toBe(true)
    expect(peerAllows('~0.2.0', '0.1.7-rc.2')).toBe(false)
