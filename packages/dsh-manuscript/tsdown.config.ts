...
export default defineConfig([
  ...
  },
  {
    ...
    sourcemap: true,
    hash: false,
    deps: { neverBundle: ['react'], alwaysBundle: ['@codemirror/state', '@codemirror/view', '@codemirror/commands', '@codemirror/language', '@codemirror/search', '@lezer/markdown', '@lezer/highlight'] },
