...
Requires Node.js 22 or newer. Build and installation, verification, removal, and rollback instructions are maintained in the repository root README. Cordis and `dsh-tools` are host-provided peers; the isolated install matrix verifies that contract from the packed tarball.
