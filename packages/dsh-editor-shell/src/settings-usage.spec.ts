...
describe('usage chart model series', () => {
  ...
  it('compacts counts with the UI locale notation (zh: 万/亿)', () => {
    expect(formatCompactNumber(0)).toBe('0')
    expect(formatCompactNumber(999)).toBe('999')
    expect(formatCompactNumber(1000)).toBe('1000')
    expect(formatCompactNumber(1500)).toBe('1500')
    expect(formatCompactNumber(51064)).toBe('5.1万')
    expect(formatCompactNumber(999_999)).toBe('100万')
    expect(formatCompactNumber(1_000_000)).toBe('100万')
    expect(formatCompactNumber(1_250_000)).toBe('125万')
    expect(formatCompactNumber(1_000_000_000_000)).toBe('1万亿')
  })
