...
function svg(size: number, ...children: ReturnType<typeof e>[]) {
  return e('svg', {
    viewBox: '0 0 24 24',
    width: size,
    height: size,
...
export function ThemePaperIcon({ size = 16 }: IconProps) {
  return svg(size,
    e('circle', { cx: '12', cy: '12', r: '3.4' }),
    e('path', { d: 'M12 3.6v2.1M12 18.3v2.1M3.6 12h2.1M18.3 12h2.1M6.2 6.2l1.5 1.5M16.3 16.3l1.5 1.5M6.2 17.8l1.5-1.5M16.3 7.7l1.5-1.5' }),
  )
}
...
export function StopIcon({ size = 16 }: IconProps) {
  return svg(size,
    e('rect', { x: '7', y: '7', width: '10', height: '10', rx: '1.2', fill: 'currentColor', stroke: 'none' }),
  )
}
